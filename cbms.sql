...
-- ALTER TABLE schedule MODIFY COLUMN docid INT(11);
-- ALTER TABLE schedule ADD CONSTRAINT fk_schedule_doctor FOREIGN KEY (docid) REFERENCES doctor(docid);
-- ALTER TABLE appointment ADD CONSTRAINT fk_appointment_schedule FOREIGN KEY (scheduleid) REFERENCES schedule(scheduleid);
